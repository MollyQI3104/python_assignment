...
def convert_irregular(c):
    ...
    if is_irregular(c):
        if c == IRREGULAR_CHARS[0]:
            return SPACE
        elif c == IRREGULAR_CHARS[1] or c == IRREGULAR_CHARS[2]:
            return HYPHEN
        elif c == IRREGULAR_CHARS[3] or c == IRREGULAR_CHARS[4] or c == IRREGULAR_CHARS[5]:
            return APOSTROPHE
...
def convert_letter(c):
    ...
    '''
    #
    letter_c = letter_column(c)
    letter_r = letter_row(c)
    return decade_pattern(letter_c) + "\n" +decade_ending(letter_r)
